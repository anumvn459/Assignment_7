<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ASGSSTN007.Contact" %>
...
<head>
    <center>
    <h1>Drop Us A Message!</h1></center>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 bg-image" style="background-image:url(https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/contact/1.jpg)">
              <div class="detail-box p-4">
                ...
                <p class="text-white op-7"> Taj Hotel
                  <br> San Bernandino</p>
                  <br>601 Sherwood Ave.</p>
                  <br>Mumbai</p>
                <h5 class="text-white font-weight-light mb-3 mt-4">CALL US</h5>
                <p class="text-white op-7">251 546 9442
                  <br> 630 446 8851</p>
                <h5 class="text-white font-weight-light mb-3 mt-4">Email ID</h5>
                <p class="text-white op-7">Tajhotel@gmail.com
